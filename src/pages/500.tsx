  ...
  return (
    <section className="min-h-screen w-full bg-black dark:bg-soft-black text-white transition-colors duration-300 ease-in-out flex items-center">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center gap-6 text-start py-16 sm:py-20 md:py-24">
          <div className="space-y-4">
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-gray-50 dark:text-white">
